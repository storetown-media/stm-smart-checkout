 ...
 * Plugin URI:        https://en.storetown-media.de/produkt/stm-smart-checkout-woocommerce/
 ...
 * Author URI:        https://en.storetown-media.de/
...
function stmc_boot() {
	...
	require_once STMC_DIR . 'includes/class-stmc-blocks.php';
